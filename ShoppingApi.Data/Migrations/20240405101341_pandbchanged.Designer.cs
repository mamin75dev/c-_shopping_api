...
namespace ShoppingApi.Data.Migrations
{
    ...
    [Migration("20240405101341_pandbchanged")]
    partial class pandbchanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingApi.Data.Models.Auth.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ShoppingApi.Data.Models.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShoppingApi.Data.Models.Auth.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingApi.Data.Models.Product", b =>
                {
                    b.HasOne("ShoppingApi.Data.Models.Brand", "Brand")
                        .WithMany("Products")
